...
export default function TabsLayout() {
  ...
  const tabIconSize = isMobile ? 28 : 22;
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Eventos',
          tabBarIcon: ({ color, focused }) => (
            <Ionicons name={focused ? 'calendar' : 'calendar-outline'} size={tabIconSize} color={color} />
          ),
        }}
      />
      <Tabs.Screen
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Adopciones',
          tabBarIcon: ({ color, focused }) => (
            <Ionicons name={focused ? 'paw' : 'paw-outline'} size={tabIconSize} color={color} />
          ),
        }}
      />
