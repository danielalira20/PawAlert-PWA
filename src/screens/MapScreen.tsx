...
export default function MapScreen() {
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      {/* Modal flotante que contiene el formulario */}
      <Modal
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 16, paddingTop: 60, paddingBottom: 40 }}>
          <View style={{ flex: 1, backgroundColor: '#F5F5F5', borderRadius: 20, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 }}>
            <ReportFormScreen onClose={() => setIsFormVisible(false)} />
          </View>
        </View>
      </Modal>

      {/* Botón flotante para registrar asociación */}
      <TouchableOpacity
      ...
      {/* Modal flotante para el formulario de asociación */}
      <Modal
