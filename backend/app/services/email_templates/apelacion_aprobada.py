def get_html(nombre_asociacion: str, respuesta: str = "", nombre_representante: str = "") -> str:
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #E2E8F0;">
  ...
  <div style="padding:32px 40px;">
    ...
    <div style="display:inline-flex;align-items:center;gap:6px;background:#EAFAF1;border:1px solid #A9DFBF;border-radius:20px;padding:5px 12px;margin-bottom:20px;">
      ...
      <span style="color:#1E8449;font-weight:600;font-size:12px;letter-spacing:0.5px;text-transform:uppercase;">Apelación aprobada</span>
    </div>

    <h1 style="color:#2C3E50;font-size:24px;font-weight:700;line-height:1.2;margin:0 0 12px;">
      ¡Tu apelación fue exitosa!
    </h1>

    <p style="color:#566573;font-size:15px;line-height:1.75;margin:0 0 24px;">
      {saludo} tras revisar tu apelación hemos decidido
      <strong style="color:#27AE60;">aprobar el registro de tu asociación</strong>.
      <strong style="color:#2C3E50;">{nombre_asociacion}</strong> ya está verificada
      y puede recibir reportes de animales en su zona.
    </p>
